...
##THIS WORKS BUT PRODUCES A BUNCH OF WARNINGS THAT I DO NOT UNDERSTAND##
...
model {
for (i in 1:4561){
Ecmin[i] <- (1-cue)*mic*(((Aupt*(exp(-Eaupt/(R*(temp[i]+273)))))*(DOC)/(Kmupt+DOC)*(Dgas*0.209*((1-(BD/PD)-theta[i]))^3/4)/(KmO2+(Dgas*0.209*((1-(BD/PD)-theta[i]))^3/4))))
cmin3[i] ~ dgamma(shape,shape/Ecmin[i])
}
